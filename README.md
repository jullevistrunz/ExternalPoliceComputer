# [ExternalPoliceComputer 1.3.2](https://www.lcpdfr.com/downloads/gta5mods/scripts/45400-externalpolicecomputer/)
...
- `wordForJail`: EPC will use this word for jail (e.g. if you prefer prison); obsolete in 1.3.3; use language.json instead
- `currency`: EPC will use this currency; obsolete in 1.3.3; use language.json instead
